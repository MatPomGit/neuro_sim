...
def test_region_and_edge_mutations_change_state_signal_and_metrics():
...
def test_ei_imbalance_and_delay_increase_change_dynamics_markers():
    state = SimulationState(
...
def test_reference_scenarios_and_pathology_config_validation():
